    ...
    <div className="navbar-container">
      ...
      {dropdownOpen && (
        <div className="sub-menu">
          ...
          <div className="sub-menu-item" onClick={() => { toggleDropdown(); navigate("/home"); }}>
            <FaHome />
            <span>Inicio</span>
          </div>
          <div className="sub-menu-item" onClick={() => { toggleDropdown(); navigate("/loss-of-biodiversity"); }}>
            <FaLeaf />
            <span>Pérdida de biodiversidad</span>
          </div>
          <div className="sub-menu-item" onClick={() => { toggleDropdown(); navigate("/deforest"); }}>
            <FaTree />
